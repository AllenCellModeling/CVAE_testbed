...
CVAE_train \
    ...
    --model_kwargs '{"x_dim": 2, "enc_layers": [6,64,64,128,128,256,256,512,512],"vae_layers": [512,512,512],"dec_layers": [516,512,256,256,128,128,64,64,2], "sklearn_data": "blobs"}'\
	--post_plot_kwargs '{"latent_space_colorbar": "no"}'\
    --beta_vae 1 \
    --C_vae 0 \
    --batch_size 64  \
...
CVAE_train \
    ...
    --post_plot_kwargs '{"latent_space_colorbar": True}'
    --beta_vae 1 \
    --C_vae 0 \
    --batch_size 64  \
    --num_batches 500  \
